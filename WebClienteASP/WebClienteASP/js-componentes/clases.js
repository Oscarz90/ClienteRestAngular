/*
//Creacion de Modulo de Clases
var clases = angular.module("Clases",['Servicios']);
...
var stringify = function (obj) {
  ...
  if (t != "object" || obj === null) {                              // Validación para cuando es un tipo de dato simple
      if (t == "string") obj = '"' + obj + '"';                     // Si es String le pone comillas dobles
      ...
      for (n in obj) {                                              // Ciclo para recorrer las propiedades del objeto
          ...
          if (t == "string") v = '"' + v + '"';                     // Valida si es string y le pone comillas dobles
          else if (t == "object" && v !== null) v = stringify(v);   // Si es object hace una llamada recursiva a "stringify"
...
clases.factory("$clases",function ($servicios){
  //Clase para realizar una llamada asnicrona a webmethod
